...
function ChatAnnouncements.PrintExperienceGain(change)
    ...
    local finalMessage = string.format("|c%s%s|r", ColorizeColors.ExperienceMessageColorize, formattedMessageP1)
...
function ChatAnnouncements.PrintGuildRep(change, lineName, lineId, priority)
    ...
    local finalMessage = string.format("|c%s%s|r", ColorizeColors.SkillGuildColorize, formattedMessageP1)
