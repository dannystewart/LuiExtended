...
function LUIE.GetLootTypeName(lootType)
    local lootTypes =
    {
        ...
        [LOOT_TYPE_IMPERIAL_FRAGMENTS] = "LOOT_TYPE_IMPERIAL_FRAGMENTS",
...
function LUIE.GetEventName(eventCode)
    local eventNames =
    {
        ...
        [EVENT_SHOW_PROMOTIONAL_EVENT_SCENE]                                  = "EVENT_SHOW_PROMOTIONAL_EVENT_SCENE",
